...
_beforeEach.givenModel = function(modelName, attrs, optionalHandler) {
  var modelKey = _.str.camelize(_.str.underscored(modelName));
  ...
  beforeEach(function(done) {
    var test = this;
    var app = this.app;
    modelName = _.str.classify(this.options[modelName] || modelName);
    ...
    model.create(attrs, function(err, result) {
      if(err) {
        ...
        test[modelKey] = test[_.str.dasherize(modelKey)] = result;
        done();
      }
    });
  });
